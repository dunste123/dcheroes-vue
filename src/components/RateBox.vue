                ...
                <div class="divSubmit">
                    <div class="row">
                        <div class="input-field col s12">
                            <textarea class="materialize-textarea" name="ratingReview" id="ratingReview" v-model="message" required></textarea>
                            <label for="ratingReview">Leave a message</label>
                        </div>
                    </div>
